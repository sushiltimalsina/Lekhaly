...
import { Box, Filter, Plus, Search, Tag } from "lucide-react";
...
const items = [
    { name: "Starter subscription", sku: "SUB-001", price: 0, status: "Active" },
    { name: "Onboarding service", sku: "SERV-201", price: 0, status: "Active" },
    { name: "Premium support", sku: "SUP-450", price: 0, status: "Inactive" },
];
            ...
            >
                <motion.header variants={item} className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
                    <div className="space-y-4">
                        ...
                        <div>
                            <h1 className="text-3xl sm:text-4xl font-semibold">Manage products & services</h1>
                            <p className="mt-2 text-muted-foreground">
                                Track pricing, SKUs, and item status for invoicing and reporting.
                            </p>
                        </div>
                    </div>
                    <div className="flex flex-col gap-3 sm:flex-row">
                        <Link
                            href="/coming-soon?feature=Item%20filters"
                        ...
                        <Link
                            href="/coming-soon?feature=Item%20creation"
                ...
                <motion.section variants={item} className="mt-8 glass-panel rounded-3xl p-6 sm:p-8">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <Link
                            href="/coming-soon?feature=Item%20export"
                            ...
                            >
                                ...
                                <div className="flex flex-wrap items-center gap-4">
                                    ...
                                    <span className="inline-flex items-center gap-2 text-xs text-muted-foreground">
                                        <Tag className="h-4 w-4" /> {formatCurrency(entry.price)}
                                    </span>
                                    <Link
                                        href="/coming-soon?feature=Item%20details"
