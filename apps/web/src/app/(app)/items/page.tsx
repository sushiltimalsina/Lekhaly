      ...
      cell: (r) => (
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            <Link href={`/items/${r.id}?from=items`} className="font-medium text-foreground truncate hover:text-primary hover:underline">{r.name}</Link>
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            {features.inventory && (
              <Link
                href={`/items/${r.id}?tab=ledger&from=items`}
