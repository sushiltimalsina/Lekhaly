...
export default function PaymentCreatePage() {
    ...
    const onSave = async () => {
        ...
        try {
            // Payment Logic:
            // Line 1: CR Cash/Bank with Total
            // Other lines: DR respective accounts/parties
    ...
    return (
        <div className="space-y-6 pb-20">
            <PageHeader
                ...
                description="Record money paid to vendors or for expenses"
                actions={
            ...
            <div className="grid gap-6 lg:grid-cols-12">
                ...
                <div className="lg:col-span-12 rounded-3xl border bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
                    <div className="grid gap-6 sm:grid-cols-4">
                        <div className="space-y-2">
                            <label className="text-sm font-medium">Pay From (Cash/Bank)</label>
                ...
                <div className="lg:col-span-12 rounded-3xl border bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
                    <div className="mb-4 flex items-center justify-between">
                        <div className="text-sm font-bold uppercase tracking-tight text-slate-400">Paid To</div>
                    </div>
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="text-muted-foreground border-b border-slate-100 dark:border-slate-800">
                                    ...
                                    <th className="pb-3 text-left font-medium">Payee (Vendor or Account)</th>
                                ...
                                <tr>
                                    ...
                                    <td className="py-6 pr-4">
                                        <div className="text-right">
                                            <div className="text-[10px] uppercase font-bold tracking-wider text-slate-400">Total Payment Amount</div>
