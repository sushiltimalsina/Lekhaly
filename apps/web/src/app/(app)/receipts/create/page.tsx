        ...
        <div className="flex h-[calc(100vh-4rem)] flex-col gap-0 overflow-hidden bg-slate-50/50 dark:bg-slate-950/50 font-sans">
            ...
            <div className="flex shrink-0 items-center justify-between border-b bg-white px-6 py-3 dark:bg-slate-900/50 shadow-sm backdrop-blur-md">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-lg font-bold tracking-tight text-slate-900 dark:text-slate-100">Add Money Receipt</h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        className="h-9 rounded-xl bg-emerald-600 px-6 font-semibold text-white shadow-lg shadow-emerald-200 hover:bg-emerald-700 dark:shadow-none"
                    >
                        <Save className="mr-2 h-4 w-4" />
                        {loading ? "Saving..." : "Save Receipt [F2]"}
                    </Button>
                </div>
            </div>
                        ...
                        <div className="grid grid-cols-12 gap-6">
                            ...
                            <div className="col-span-2 space-y-1.5">
                                ...
                                <Input
                                    ...
                                    readOnly
                                    className="h-10 rounded-xl bg-slate-50 border-slate-200 font-mono font-bold text-emerald-600"
                                />
                            </div>
                            <div className="col-span-4 space-y-1.5">
                                ...
                                <Input
                                    ...
                                    className="h-10 rounded-xl border-slate-200 hover:border-slate-300 focus:ring-emerald-500"
                                />
                            </div>
                        </div>
                    </div>
                            ...
                            <table className="w-full border-collapse">
                                <thead className="bg-slate-50/80 sticky top-0 z-10 dark:bg-slate-800/50">
                                    <tr className="text-[11px] font-bold uppercase tracking-widest text-slate-500">
                                        ...
                                        <th className="px-4 py-3 text-left min-w-[300px]">Payer (Party or Account)</th>
                                        ...
                                        <tr key={line.id} className="group hover:bg-slate-50/50 dark:hover:bg-slate-800/20 transition-colors">
                                            ...
                                            <td className="px-2 py-2.5">
                                                <Input
                                                    ...
                                                    placeholder="0.00"
                                                    className="h-9 rounded-xl bg-white border-slate-200 text-right font-bold text-emerald-600 focus:ring-emerald-500"
                                                />
                                            </td>
                            ...
                            <div className="grid grid-cols-12 items-center gap-4">
                                <div className="col-span-3">
                                    <Button
                                        variant="outline"
                                        onClick={addLine}
                                        className="rounded-xl border-dashed border-slate-300 text-slate-500 hover:text-emerald-600 hover:border-emerald-400 hover:bg-white h-9 px-4 transition-all"
                                    >
                                        <Plus className="mr-2 h-4 w-4" />
                                        Add Payer Row [Ins]
                                    </Button>
                                </div>
                                <div className="col-span-5 text-right font-semibold text-slate-500 text-xs uppercase tracking-wider">Total Receipt Amount</div>
                    ...
                    <div className="mt-6 grid grid-cols-12 gap-6">
                        <div className="col-span-8 space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="Explain the source of this money..."
                                className="min-h-[100px] w-full rounded-3xl border-slate-200 bg-white p-4 text-sm shadow-sm outline-none ring-emerald-500/10 focus:border-emerald-500 focus:ring-4 dark:border-slate-800 dark:bg-slate-900"
                            />
                        </div>
                        <div className="col-span-4 flex flex-col justify-end space-y-4">
                            <div className="rounded-3xl border border-dashed border-slate-200 p-4 bg-slate-50/50">
                                ...
                                <div className="flex items-center justify-between mt-1">
                                    ...
                                    <span className="text-sm font-black text-emerald-600"><MoneyText value={total} /></span>
                                </div>
                            </div>
                            <div className="flex gap-3">
                                <Button
                                    className="h-11 flex-1 rounded-2xl bg-emerald-600 font-bold text-white shadow-lg shadow-emerald-100 hover:bg-emerald-700"
                                    onClick={onSave}
                                    disabled={total <= 0}
                                >
                                    SAVE RECEIPT [F2]
                    ...
                    <div className="p-6 flex flex-col flex-1 overflow-y-auto">
                        ...
                        <div className="mt-8">
                            ...
                            <div className="space-y-2">
                                {[1, 2, 3].map((_, i) => (
                                    <div key={i} className="p-3 rounded-2xl border bg-white text-xs hover:border-emerald-200 cursor-pointer transition-all dark:bg-slate-900 dark:border-slate-800">
                                        <div className="flex justify-between font-bold mb-1">
                                            <span>R-00{4 - i}</span>
                                            <span className="text-emerald-600">Rs. 1,500</span>
                                        </div>
                                        <div className="text-slate-400 truncate">Cash received from Walk-in</div>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="mt-auto pt-8">
                            <div className="rounded-3xl bg-emerald-600 p-5 text-white shadow-xl shadow-emerald-100">
                                <div className="mb-3 flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                                    <HelpCircle className="h-4 w-4" />
                                </div>
                                <h4 className="text-xs font-bold uppercase tracking-wider mb-2">Payer Tip</h4>
                                <p className="text-[11px] leading-relaxed opacity-90">
                                    Select a <strong>Party</strong> for customer balance tracking, or select a <strong>General Account</strong> for direct income or transfers.
                                </p>
                            </div>
                        </div>
                    </div>
