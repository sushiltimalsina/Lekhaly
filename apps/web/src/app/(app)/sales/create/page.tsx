            ...
            <div className="border-b border-zinc-200 px-3 py-2 dark:border-zinc-700">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white py-2 pl-8 pr-3 text-sm outline-none focus:ring-2 focus:ring-emerald-500/20 dark:border-zinc-700 dark:bg-zinc-950"
                />
              </div>
            </div>
          ...
          <div className="relative max-w-[980px]">
            ...
            {!form.partyId && isEditMode && (
              <Button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 h-10 rounded-full px-4 text-xs bg-white text-slate-900 border border-slate-200 hover:!bg-emerald-600 hover:!text-white hover:!border-emerald-600 dark:bg-slate-900 dark:text-slate-100 dark:border-slate-800 transition-colors shadow-sm active:scale-95"
              >
        ...
        <section className="grid gap-6 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 rounded-3xl border bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-zinc-950">
            ...
            <textarea
              ...
              className="min-h-[120px] w-full rounded-2xl border-2 border-slate-100 bg-slate-50/30 p-5 text-sm outline-none ring-emerald-500/10 focus:border-emerald-500 focus:bg-white focus:ring-4 dark:border-slate-800 dark:bg-zinc-950 dark:text-slate-300 transition-all font-medium leading-relaxed"
              disabled={!isEditMode}
            />
          </div>
