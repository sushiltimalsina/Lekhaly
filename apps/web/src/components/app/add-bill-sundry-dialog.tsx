                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4 text-foreground">
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        <button
                            type="button"
                            onClick={onClose}
                            className="h-11 px-6 rounded-2xl text-[11px] font-bold border border-border hover:bg-accent transition-all text-muted-foreground"
                        >
                            CANCEL
                        </button>
                        <button
                            type="submit"
                            disabled={saving}
                            className="h-11 px-8 rounded-2xl text-[11px] font-bold bg-indigo-600 text-white hover:bg-indigo-700 shadow-xl shadow-indigo-200 dark:shadow-none transition-all flex items-center gap-2"
                        >
