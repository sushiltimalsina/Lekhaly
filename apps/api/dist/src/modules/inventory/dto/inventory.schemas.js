...
exports.InventorySettingsSchema = zod_1.z.object({
    ...
    adjustmentApprovalRequired: zod_1.z.boolean().optional(),
    transferApprovalRequired: zod_1.z.boolean().optional(),
    negativeStockApprovalRequired: zod_1.z.boolean().optional(),
    reversalApprovalRequired: zod_1.z.boolean().optional(),
