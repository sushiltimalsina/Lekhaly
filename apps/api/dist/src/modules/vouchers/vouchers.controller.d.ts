...
export declare class VouchersController {
    ...
    createDraft(user: AuthUser, body: any, idempotencyKey?: string): Promise<any>;
    ...
    post(user: AuthUser, id: string, idempotencyKey?: string): Promise<any>;
    void(user: AuthUser, id: string, idempotencyKey?: string): Promise<any>;
}
