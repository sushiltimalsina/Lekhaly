...
exports.CompanySchema = zod_1.z.object({
    ...
    purchasePrefix: zod_1.z.string().trim().min(1).max(10).optional(),
    salesReturnPrefix: zod_1.z.string().trim().min(1).max(10).optional(),
    purchaseReturnPrefix: zod_1.z.string().trim().min(1).max(10).optional(),
    ...
    receiptPrefix: zod_1.z.string().trim().min(1).max(10).optional(),
    paymentPrefix: zod_1.z.string().trim().min(1).max(10).optional(),
    journalPrefix: zod_1.z.string().trim().min(0).max(10).optional(),
    invoiceSuffix: zod_1.z.string().trim().max(10).optional(),
    purchaseSuffix: zod_1.z.string().trim().max(10).optional(),
    salesReturnSuffix: zod_1.z.string().trim().max(10).optional(),
    purchaseReturnSuffix: zod_1.z.string().trim().max(10).optional(),
    orderSuffix: zod_1.z.string().trim().max(10).optional(),
    quotationSuffix: zod_1.z.string().trim().max(10).optional(),
    purchaseOrderSuffix: zod_1.z.string().trim().max(10).optional(),
    receiptSuffix: zod_1.z.string().trim().max(10).optional(),
    paymentSuffix: zod_1.z.string().trim().max(10).optional(),
    journalSuffix: zod_1.z.string().trim().max(10).optional(),
    nextInvoiceNumber: zod_1.z.number().int().min(1).optional(),
    nextPurchaseNumber: zod_1.z.number().int().min(1).optional(),
    nextSalesReturnNumber: zod_1.z.number().int().min(1).optional(),
    nextPurchaseReturnNumber: zod_1.z.number().int().min(1).optional(),
    ...
    nextReceiptNumber: zod_1.z.number().int().min(1).optional(),
    nextPaymentNumber: zod_1.z.number().int().min(1).optional(),
    nextJournalNumber: zod_1.z.number().int().min(1).optional(),
