...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(auth_schemas_1.TotpEnableSchema.extend({ userId: auth_schemas_1.TotpEnableSchema.shape.code.transform(() => undefined) }).passthrough())),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, common_1.UsePipes)(new zod_pipe_1.ZodValidationPipe(auth_schemas_1.StepUpSchema.extend({ userId: auth_schemas_1.StepUpSchema.shape.code.transform(() => undefined) }).passthrough())),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
