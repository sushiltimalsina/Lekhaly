                                        ...
                                        <tr className="bg-white/30 dark:bg-transparent">
                                            <td colSpan={7} className="px-6 py-1.5">
                                                <div className="flex gap-4 text-[9px] text-slate-400 italic">
                                                    ...
                                                    <span>Press <kbd className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-slate-800 border text-[8px] not-italic font-sans">Shift + Enter</kbd> in Short Note to jump to Add. Notes</span>
                                                </div>
                                            </td>
                                        </tr>
                                        {lines.map((line, idx) => (
