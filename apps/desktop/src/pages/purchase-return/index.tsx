                ...
                <PageHeader
                    ...
                    actions={
                        <Button
                            ...
                            className="rounded-2xl h-12 px-6 bg-sky-600 text-white font-bold hover:bg-sky-700 hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 shadow-md shadow-sky-600/20 border-none"
                        >
                ...
                {loading && data.length === 0 ? (
                                        ...
                                        <React.Fragment key={item.id}>
                                            <tr className="group hover:bg-sky-50/20 dark:hover:bg-sky-900/10 transition-colors">
                                                ...
                                                {visibleColumns.includes("returnNo") && (
                                                    <td className={`px-6 ${py} whitespace-nowrap`}>
                                                        <span
                                                            onClick={() => navigate(`/purchase-return/create?id=${item.id}`)}
                    ...
                    <div className="flex flex-col items-center justify-center py-32 px-6 text-center space-y-4">
                        ...
                        <Button
                            ...
                            className="bg-sky-600 rounded-2xl h-11 px-8 font-black text-xs uppercase tracking-widest shadow-xl shadow-sky-500/20 text-white hover:bg-sky-700 transition-all"
                        >
                            Reset Audit Filters
                        </Button>
                    </div>
