    ...
    if (!order) {
        return (
            <div className="flex flex-col items-center justify-center py-24 px-6 text-center space-y-4">
                ...
                <Button onClick={() => navigate("/purchase-orders")} variant="outline" className="rounded-2xl border-2 font-black text-[10px] uppercase tracking-widest border-orange-100 text-orange-600 hover:bg-orange-50">
                    Back to Registry
                </Button>
            </div>
        );
