...
export default function DayBookPage() {
    ...
    const columns: Column<VoucherRecord>[] = [
        ...
        },
        {
            key: "memo",
            header: "Memo",
            cell: (r) => <div className="text-sm text-slate-600 dark:text-slate-400 truncate max-w-xs">{r.memo ?? "â€”"}</div>
        },
        {
            key: "status",
            header: "Status",
        ...
        },
        {
            ...
            width: 80,
            cell: (r) => (
                <Link to={`/vouchers/${r.id}`} className="p-1.5 hover:bg-primary/10 rounded-full transition-colors group block">
