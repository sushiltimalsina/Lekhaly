  ...
  const columns: Column<Row>[] = [
    {
      ...
      cell: (r) => (
        <div className="flex flex-col py-1">
          <span className="font-bold text-foreground">{r.partyName ?? "â€”"}</span>
        </div>
      ),
    },
    {
    ...
    {
      key: "1-30",
      header: <span className="w-full block text-right">1â€“30 Days</span>,
      align: "right",
      width: 120,
    ...
    {
      key: "31-60",
      header: <span className="w-full block text-right">31â€“60 Days</span>,
      align: "right",
      width: 120,
    ...
    {
      key: "61-90",
      header: <span className="w-full block text-right">61â€“90 Days</span>,
      align: "right",
      width: 120,
