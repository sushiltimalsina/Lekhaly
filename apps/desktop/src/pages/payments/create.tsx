            ...
            <div className="flex flex-col gap-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold italic tracking-tight text-slate-900 dark:text-slate-100 italic">Cash Payment</h1>
                            <p className="text-xs text-muted-foreground mt-0.5 font-medium">Record outgoing funds</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <Button
                            ...
                            className={cn(
                                ...
                                showHistory && "bg-rose-50 border-rose-200 text-rose-600"
                            )}
                        >
                        ...
                        <Button variant="outline" size="sm" onClick={() => navigate(-1)} className="rounded-xl border-slate-200 h-9">
                            Cancel
                        </Button>
                    </div>
                </div>
                                ...
                                <table className="w-full text-left border-collapse min-w-[1000px]">
                                    <thead>
                                        <tr className="border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40">
                                            ...
                                            <th className="px-2 py-4 text-[10px] font-black uppercase tracking-wider text-slate-400 w-[400px]">Account/Payee Detail</th>
                                    ...
                                    <tbody className="divide-y divide-slate-50 dark:divide-slate-800/50">
                                        ...
                                        {lines.map((line, idx) => (
                                            <tr key={line.id} className="group hover:bg-slate-50/50 dark:hover:bg-rose-900/5 transition-colors duration-200">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 bg-white dark:bg-slate-900/50 p-6 md:p-8 rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-sm">
                    <div className="flex flex-wrap items-center gap-8">
                        <div className="flex flex-col">
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">To (Dr)</span>
                        ...
                        <div className="flex flex-col">
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Out (Cr)</span>
            ...
            >
                <div className="flex flex-col h-full bg-slate-50/30 dark:bg-slate-900/50">
                    <div className="p-8 pb-4 flex items-center justify-between border-b border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900">
                        <div className="flex items-center gap-3">
                            <div className="h-8 w-8 rounded-xl bg-rose-50 dark:bg-rose-900/30 flex items-center justify-center">
