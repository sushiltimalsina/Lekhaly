      ...
      <form onSubmit={onSubmit} className="max-w-4xl mx-auto">
        <div className="rounded-[2.5rem] border bg-card p-10 shadow-sm space-y-8 dark:border-slate-800">
          ...
          <div className="grid gap-8">
              ...
              <label className="space-y-2 text-sm">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-14 rounded-2xl bg-slate-50 dark:bg-slate-900 border-slate-200 dark:border-slate-800 pl-12"
                  />
                </div>
              </label>
            ...
            <label className="space-y-2 text-sm">
              <span className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">Address</span>
              <div className="relative">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              <label className="space-y-2 text-sm">
                <span className="text-xs font-bold text-slate-500 uppercase tracking-wider ml-1">PAN Number</span>
                <div className="relative">
              ...
              <div className="rounded-2xl bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-xl bg-white dark:bg-slate-950 flex items-center justify-center border border-slate-200 dark:border-slate-800">
                    <Banknote className="h-5 w-5 text-slate-500" />
                  </div>
                  <div>
                    <div className="text-sm font-bold">Opening Balance</div>
                    <div className="text-xs text-muted-foreground">Optional receivable or payable amount.</div>
                  </div>
                </div>
              </div>
            </div>
