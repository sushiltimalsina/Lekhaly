                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="space-y-4">
                        <label className="space-y-1.5 block">
                            <span className="text-[10px] font-bold text-muted-foreground ml-1 uppercase tracking-tight">Unit Name</span>
                            <Input
                                autoFocus
                                value={name}
                                onChange={e => setName(e.target.value)}
                                placeholder="e.g. PCS, KG, Box, Meters"
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        ...
                        <button
                            type="submit"
                            disabled={saving}
                            className="h-11 px-8 rounded-2xl text-[11px] font-bold bg-blue-600 text-white hover:bg-blue-700 shadow-xl shadow-blue-200 dark:shadow-none transition-all flex items-center gap-2 tracking-wider"
                        >
